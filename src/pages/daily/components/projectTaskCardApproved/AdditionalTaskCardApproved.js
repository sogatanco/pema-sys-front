...
import './ProjectTaskCardApproved.scss';

const AdditionalTaskCardApproved = ({ filters, setReviewTotal }) => {
  const api = useAxios();
...
AdditionalTaskCardApproved.propTypes = {
...
export default AdditionalTaskCardApproved;
