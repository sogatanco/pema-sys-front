...
const ModalDocs = ({ modalDoc, toggleDoc, sppdDetail }) => {
      ...
      content: [
        pdfContent,
        {
          stack: [
            {
              text: `Banda Aceh, ${
                detailSppd?.approval.filter((a) => a.type === ts)[0]?.updated_at
            ...
            {
              image: `${
                detailSppd?.approval.filter((a) => a.type === ts)[0]?.status === 'approve'
                  ? qrcode
                  : image.placeholder
              }`,
    ...
    for (let i = 0; i < detailSppd?.tujuan_sppd?.length; i++) {
      tujuans += `<table cellpadding="5" cellspacing="0" width="100%">
        ...
        <tr style="border:none">
          ...
          <td style="width: 70%; text-align: left;height:15px; vertical-align:middle!important">: ${
            detailSppd?.tujuan_sppd[i].tugas
          }</td>
        </tr>
         <tr style="border:none">
          <td style="width: 30%; text-align: left; height:15px; vertical-align:middle!important">TUJUAN</td>
          <td style="width: 70%; text-align: left;height:15px; vertical-align:middle!important">: ${
            detailSppd?.tujuan_sppd[i].detail_tujuan
          }</td>
        </tr>
         <tr style="border:none">
          <td style="width: 30%; text-align: left; height:15px; vertical-align:middle!important">LAMA TUGAS</td>
          <td style="width: 70%; text-align: left;height:15px; vertical-align:middle!important">: ${
            detailSppd?.tujuan_sppd[i].jumlah_hari
          } hari</td>
        </tr>
         <tr style="border:none">
         ...
         <tr style="border:none">
          ...
          <td style="width: 70%; text-align: left;height:15px; vertical-align:middle!important">: ${
            detailSppd?.tujuan_sppd[i].sumber_biaya
          }</td>
        </tr>
        </tbody>
      </table><br>`;
            ...
            <td style="width: 50%;border:none;">
               ...
               <table cellpadding="5" cellspacing="0" width="100%" style="margin-top:-5">
                ...
                <tr style="border:none">
                  ...
                  <tr>
                    <td style="width: 7%;margin-bottom:5px; margin-top:4px;" rowspan="${
                      detailSppd?.tujuan_sppd?.length + 1
                    }">8.</td>
                   ...
                   <tr>
                    <td style="width: 93%;margin-bottom:8px; margin-top:7px;" colspan="3"><i>${
                      detailSppd?.approval.filter((a) => a.type === typeSign)[0]?.ket || '<br><br>'
                    }</i></td>
                  </tr>
                </tbody>
              </table>
  ...
  const printRealisasi = () => {
    ...
    if (detailSppd.realisasi_status) {
      ...
      for (let i = 0; i < detailSppd?.realisasi_biaya?.length; i++) {
        tets += `<li style="margin-bottom:10px;"><span><strong> Tujuan SPPD : ${
      ...
      <table cellspacing="0" width="100%" style="margin-top:-10">
        ...
        <tr>
            ...
            <td style="margin-bottom:5px; margin-top:4px; border-right:none;border-left:none">${
              detailSppd?.realisasi_biaya[i]?.p_tiket
            }% PEMA </td>
          ...
          <tr>
            ...
            <td style="margin-bottom:5px; margin-top:4px; border-right:none;border-left:none">${
              detailSppd?.realisasi_biaya[i]?.p_um
            }% PEMA </td>
            <td style="margin-bottom:5px; margin-top:4px;border-left:none;border-right:none" >${rupiah(
          ...
          <tr>
            ...
            <td style="margin-bottom:5px; margin-top:4px; border-right:none;border-left:none">${
              detailSppd?.realisasi_biaya[i]?.p_tl
            }% PEMA </td>
            <td style="margin-bottom:5px; margin-top:4px;border-left:none;border-right:none" >${rupiah(
          ...
          <tr>
            ...
            <td style="margin-bottom:5px; margin-top:4px; border-right:none;border-left:none">${
              detailSppd?.realisasi_biaya[i]?.p_us
            }% PEMA </td>
            <td style="margin-bottom:5px; margin-top:4px;border-left:none;border-right:none" >${rupiah(
            ...
            <td style="margin-bottom:5px; margin-top:4px; border-right:none;border-left:none">${
              detailSppd?.realisasi_biaya[i]?.p_hotel
            }% PEMA </td>
            <td style="margin-bottom:5px; margin-top:4px;border-left:none;border-right:none" >${rupiah(
        ...
        <table cellpadding="5" cellspacing="0" width="100%">
          <tbody>
            <tr>
              ...
              <td style="width:50%;margin-bottom:5px; margin-top:4px;border-left:none" >: ${
                detailSppd?.employe_id
              }</td>
            </tr>
            <tr>
  ...
  const printChecklist = () => {
    ...
    if (detailSppd.realisasi_status) {
      ...
      for (let i = 0; i < detailSppd?.check_doc?.length; i++) {
        tets += ` <tr>
              ...
              <td style="margin-bottom:5px; margin-top:4px;">${
                detailSppd?.check_doc[i].doc_name
              }</td>
               <td style="margin-bottom:5px; margin-top:4px;text-align:center">${
                 detailSppd?.check_doc[i].status === 1 ? 'Ada' : 'Tidak Ada'
               }</td>
            </tr>`;
      }
    ...
    <tbody>
      ...
      <p>Dokumen ini Disajikan oleh\t\t\t\t\t: <strong>${
        detailSppd?.realisasi?.submitter_name
      }</strong><br> Direview oleh \t\t\t\t\t\t\t\t\t\t\t\t: <strong>${
        detailSppd?.approval?.filter((f) => f.type === 'check_document')[0]?.status === 'approve'
      ...
      <table cellspacing="0" width="100%" style="margin-top:-17">
        <tbody>
          <tr>
            ...
            <td style="width:50%;margin-bottom:5px; margin-top:4px;border-left:none;border-right:none" >: ${
              detailSppd?.tujuan_sppd[i]?.jenis_sppd
            }</td>
          </tr>         
          <tr>
            <td style="width:48%;margin-bottom:5px; margin-top:4px; border-right:none;border-left:none">Kategori</td </td>
            <td style="width:50%;margin-bottom:5px; margin-top:4px;border-left:none;border-right:none" >: ${
              detailSppd?.tujuan_sppd[i]?.categori_sppd
            }</td>
          </tr> 
           <tr>
          ...
          <tr>
            ...
            <td style="width:50%;margin-bottom:5px; margin-top:4px;border-left:none;border-right:none" >: ${
              detailSppd?.tujuan_sppd[i]?.renbis || '-'
            }</td>
          </tr>         
          <tr>
